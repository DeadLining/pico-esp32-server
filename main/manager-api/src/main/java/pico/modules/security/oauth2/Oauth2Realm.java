...
public class Oauth2Realm extends AuthorizingRealm {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
        ...
        // Recheck on every request so old ordinary-user tokens cannot bypass login policy.
        if (userEntity == null || !Integer.valueOf(SuperAdminEnum.YES.value()).equals(userEntity.getSuperAdmin())) {
            throw new DisabledAccountException("Administrator access required");
        }
