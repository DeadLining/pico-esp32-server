...
import pico.common.validator.group.AddGroup;
import pico.common.validator.group.DefaultGroup;
import pico.common.validator.group.UpdateGroup;
...
import pico.modules.sys.utils.WebSocketValidator;
...
public class SysParamsController {
    ...
    private void validateMqttSecretLength(String paramCode, String secret) {
        ...
        // 不允许包含弱密码
        String[] weakPasswords = { "test", "1234", "admin", "password", "qwerty", "pico" };
