package pico.modules.sys.controller;
...
import pico.common.annotation.LogOperation;
...
import pico.modules.sys.dto.EmitSeverActionDTO;
import pico.modules.sys.dto.ServerActionPayloadDTO;
import pico.modules.sys.dto.ServerActionResponseDTO;
import pico.modules.sys.enums.ServerActionEnum;
import pico.modules.sys.service.SysParamsService;
import pico.modules.sys.utils.WebSocketClientManager;
...
public class ServerSideManageController {
    ...
    private Boolean emitServerActionByWs(String targetWsUri, ServerActionEnum actionEnum) {
        ...
        String redisKey = pico.common.redis.RedisKeys.getTmpRegisterMacKey(deviceId);
