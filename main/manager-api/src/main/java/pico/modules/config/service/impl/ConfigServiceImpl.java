...
import pico.modules.agent.entity.AgentVoicePrintEntity;
...
import pico.modules.agent.vo.AgentVoicePrintVO;
import pico.modules.correctword.vo.CorrectWordSimpleVO;
...
import pico.modules.timbre.vo.TimbreDetailsVO;
import pico.modules.voiceclone.entity.VoiceCloneEntity;
...
public class ConfigServiceImpl implements ConfigService {
    ...
    private void buildModuleConfig(
        ...
        if (StringUtils.isNotBlank(prompt)) {
            prompt = prompt.replace("{{assistant_name}}", StringUtils.isBlank(assistantName) ? "Pico" : assistantName);
        }
