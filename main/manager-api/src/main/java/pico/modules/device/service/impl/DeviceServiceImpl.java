package pico.modules.device.service.impl;
...
import pico.common.utils.DateUtils;
import pico.common.utils.JsonUtils;
import pico.modules.device.dao.DeviceDao;
import pico.modules.device.dto.DeviceManualAddDTO;
import pico.modules.device.dto.DevicePageUserDTO;
import pico.modules.device.dto.DeviceReportReqDTO;
import pico.modules.device.dto.DeviceReportRespDTO;
...
import pico.modules.device.service.OtaService;
import pico.modules.device.vo.UserShowDeviceListVO;
...
public class DeviceServiceImpl extends BaseServiceImpl<DeviceDao, DeviceEntity> implements DeviceService {
    ...
    public DeviceReportRespDTO checkDeviceActive(String macAddress, String clientId, DeviceReportReqDTO deviceReport) {
        ...
        if (StringUtils.isBlank(wsUrl) || wsUrl.equals("null")) {
            ...
            wsUrl = "ws://pico.server.com:8000/pico/v1/";
            ...
            if (wsUrls.length > 0) {
                ...
                log.error("WebSocket地址未配置，请登录智控台，在参数管理找到【server.websocket】配置");
                websocket.setUrl("ws://pico.server.com:8000/pico/v1/");
            }
        }
