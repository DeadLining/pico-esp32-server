...
import pico.modules.agent.entity.AgentTagRelationEntity;
...
import pico.modules.model.entity.ModelConfigEntity;
...
public class AgentSnapshotServiceImpl extends BaseServiceImpl<AgentSnapshotDao, AgentSnapshotEntity>
    ...
    private List<pico.modules.agent.dto.ContextProviderDTO> getContextProviders(String agentId) {
    ...
    private void restoreContextProviders(String agentId,
            List<pico.modules.agent.dto.ContextProviderDTO> contextProviders) {
