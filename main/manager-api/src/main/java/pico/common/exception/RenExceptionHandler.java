...
public class RenExceptionHandler {
    ...
    public Result<Void> handleNoSuchElementException(java.util.NoSuchElementException ex) {
        return new Result<Void>().error(404, ex.getMessage() == null ? "not found" : ex.getMessage());
    }
