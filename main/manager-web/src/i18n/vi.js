export default {
  ...
  'header.deviceManagement': 'Quản lý thiết bị',
  ...
  'firmwareDialog.uploadHint': 'Nhắc nhở: Vui lòng tải lên tệp pico.bin đã hợp nhất trước, không phải tệp merged-binary.bin đã hợp nhất',
  ...
  'register.welcome': 'Chào mừng đến với Pico AI',
  ...
  'paramManagement.updateSuccess': 'Cập nhật thành công. Một số cấu hình chỉ có hiệu lực sau khi khởi động lại mô-đun pico-server.',
  ...
  'roleConfig.tooltip.contextProvider': 'Khi Pico được kích hoạt, lấy dữ liệu từ hệ thống bên ngoài và tiêm động vào lời nhắc hệ thống của LLM',
  ...
  'modelConfig.effectiveConfig': 'Đang có hiệu lực',
  'modelConfig.inUse': 'Đang dùng',
  'modelConfig.noEffective': 'Chưa có cấu hình hiệu lực',
  'modelConfig.showPresets': 'Hiện thêm {count} mục đặt trước',
  'modelConfig.hidePresets': 'Ẩn mục đặt trước',
  ...
  'modelConfig.setDefaultSuccess': 'Đặt mô hình mặc định thành công, vui lòng khởi động lại module pico-server thủ công kịp thời',
  ...
  'knowledgeBaseManagement.ragConfig': 'Mô hình cơ sở tri thức',
  'knowledgeBaseManagement.ragConfigHint': 'Mô hình vector và truy xuất dùng cho cơ sở tri thức. Cấu hình này thuộc tính năng cơ sở tri thức, không còn hiển thị trong cấu hình mô hình.',
  'knowledgeBaseManagement.ragConfigLoadFailed': 'Không tải được mô hình cơ sở tri thức',
  'systemSettings.pageTitle': 'Cài đặt hệ thống',
  'systemSettings.reload': 'Tải lại',
  'systemSettings.save': 'Lưu',
  'systemSettings.saving': 'Đang lưu',
  'systemSettings.hint': 'Chỉ giữ các tham số máy chủ Pico cần thiết. Thay đổi có hiệu lực ngay; hãy đảm bảo thiết bị truy cập được các địa chỉ này.',
  'systemSettings.groupBasic': 'Thông tin cơ bản',
  'systemSettings.groupConnect': 'Địa chỉ dịch vụ',
  'systemSettings.groupSecurity': 'Bảo mật',
  'systemSettings.groupIce': 'Thông tin đăng ký',
  'systemSettings.serverName': 'Tên Pico',
  'systemSettings.serverNameHint': 'Tên dịch vụ hiển thị trên thiết bị và bảng điều khiển.',
  'systemSettings.frontendUrl': 'Địa chỉ bảng điều khiển',
  'systemSettings.frontendUrlHint': 'Địa chỉ bảng điều khiển hiển thị cho thiết bị.',
  'systemSettings.authEnabled': 'Bật xác thực dịch vụ',
  'systemSettings.authEnabledHint': 'Khi tắt, thiết bị kết nối không cần token. Chỉ dùng để gỡ lỗi nội bộ.',
  'systemSettings.websocket': 'Địa chỉ WebSocket',
  'systemSettings.websocketHint': 'Nhiều địa chỉ cách nhau bằng dấu chấm phẩy; thiết bị phải truy cập được.',
  'systemSettings.ota': 'Địa chỉ OTA',
  'systemSettings.otaHint': 'Địa chỉ thiết bị kiểm tra cập nhật firmware.',
  'systemSettings.serverSecret': 'Khóa máy chủ',
  'systemSettings.serverSecretHint': 'Thiết bị dùng khóa này để truy cập API cấu hình. Cập nhật phía thiết bị sau khi đổi.',
  'systemSettings.secretUnchanged': 'Để trống để giữ khóa hiện tại.',
  'systemSettings.beianIcp': 'Số đăng ký ICP',
  'systemSettings.beianGa': 'Số đăng ký công an',
  'systemSettings.loadFailed': 'Không tải được tham số hệ thống',
  'systemSettings.noChange': 'Không có thay đổi để lưu',
  'systemSettings.saveSuccess': 'Đã lưu cài đặt hệ thống',
  'systemSettings.savePartialFailed': '{count} mục lưu thất bại; kiểm tra định dạng địa chỉ rồi thử lại',
