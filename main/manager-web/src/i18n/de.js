export default {
  ...
  'header.deviceManagement': 'Geräteverwaltung',
  'header.systemSettings': 'Systemeinstellungen',
  ...
  'firmwareDialog.uploadHint': 'Hinweis: Bitte die vorab zusammengeführte pico.bin-Datei hochladen, nicht die zusammengeführte merged-binary.bin-Datei',
  ...
  'register.welcome': 'Willkommen bei Pico AI',
  ...
  'paramManagement.updateSuccess': 'Aktualisierung erfolgreich. Einige Konfigurationen werden erst nach Neustart des pico-server-Moduls wirksam.',
  ...
  'roleConfig.tooltip.contextProvider': 'Wenn Pico aktiviert wird, werden externe Systemdaten abgerufen und dynamisch in die Systemaufforderung des LLM eingefügt',
  ...
  'modelConfig.effectiveConfig': 'Derzeit aktiv',
  'modelConfig.inUse': 'In Verwendung',
  'modelConfig.noEffective': 'Noch keine aktive Konfiguration',
  'modelConfig.showPresets': '{count} weitere Voreinstellungen anzeigen',
  'modelConfig.hidePresets': 'Voreinstellungen ausblenden',
  ...
  'modelConfig.setDefaultSuccess': 'Standardmodell erfolgreich gesetzt, bitte starten Sie das pico-server-Modul zeitnah manuell neu',
  ...
  'knowledgeBaseManagement.ragConfig': 'Wissensdatenbank-Modell',
  'knowledgeBaseManagement.ragConfigHint': 'Vektor- und Retrieval-Modell der Wissensdatenbank. Diese Konfiguration gehört zur Wissensdatenbank und wird nicht mehr unter der Modellkonfiguration angezeigt.',
  'knowledgeBaseManagement.ragConfigLoadFailed': 'Wissensdatenbank-Modelle konnten nicht geladen werden',
  'systemSettings.pageTitle': 'Systemeinstellungen',
  'systemSettings.reload': 'Neu laden',
  'systemSettings.save': 'Speichern',
  'systemSettings.saving': 'Speichern',
  'systemSettings.hint': 'Hier werden nur die von Pico benötigten Serverparameter verwaltet. Änderungen wirken sofort; die Adressen müssen für Geräte erreichbar sein.',
  'systemSettings.groupBasic': 'Allgemein',
  'systemSettings.groupConnect': 'Dienstadressen',
  'systemSettings.groupSecurity': 'Sicherheit',
  'systemSettings.groupIce': 'Registrierungsangaben',
  'systemSettings.serverName': 'Pico-Name',
  'systemSettings.serverNameHint': 'Dienstname für Geräte und Konsole.',
  'systemSettings.frontendUrl': 'Konsolen-URL',
  'systemSettings.frontendUrlHint': 'Konsoleneingang, der Geräten angezeigt wird.',
  'systemSettings.authEnabled': 'Dienstauthentifizierung',
  'systemSettings.authEnabledHint': 'Wenn deaktiviert, verbinden sich Geräte ohne Token-Prüfung. Nur für Intranet-Debugging.',
  'systemSettings.websocket': 'WebSocket-Adressen',
  'systemSettings.websocketHint': 'Mehrere Adressen mit Semikolon trennen; sie müssen für Geräte erreichbar sein.',
  'systemSettings.ota': 'OTA-Adresse',
  'systemSettings.otaHint': 'Adresse, unter der Geräte nach Firmware-Updates suchen.',
  'systemSettings.serverSecret': 'Server-Schlüssel',
  'systemSettings.serverSecretHint': 'Wird von Geräten für die Konfigurations-API verwendet. Nach Änderung Geräteseite aktualisieren.',
  'systemSettings.secretUnchanged': 'Leer lassen, um den aktuellen Schlüssel beizubehalten.',
  'systemSettings.beianIcp': 'ICP-Registrierungsnummer',
  'systemSettings.beianGa': 'Nummer der öffentlichen Sicherheit',
  'systemSettings.loadFailed': 'Systemparameter konnten nicht geladen werden',
  'systemSettings.noChange': 'Keine Änderungen zu speichern',
  'systemSettings.saveSuccess': 'Systemeinstellungen gespeichert',
  'systemSettings.savePartialFailed': '{count} Einträge konnten nicht gespeichert werden; Adressformat prüfen und erneut versuchen',
