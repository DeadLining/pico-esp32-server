export default {
  ...
  'header.logout': '退出登錄',
  'header.deviceManagement': '裝置管理',
  'header.systemSettings': '系統設定',
  ...
  'firmwareDialog.uploadHint': '溫馨提示：請上傳合併前的pico.bin文件，而不是合併後的merged-binary.bin文件',
  ...
  'paramManagement.updateSuccess': '修改成功，部分配置需重啟pico-server模組才生效',
  ...
  'roleConfig.tooltip.contextProvider': '在Pico被喚醒時，獲取外部系統的資料，並將其動態注入到大模型的系統提示詞中',
  ...
  'modelConfig.effectiveConfig': '目前生效',
  'modelConfig.inUse': '使用中',
  'modelConfig.noEffective': '尚未選擇生效設定',
  'modelConfig.showPresets': '展開其餘 {count} 項預設',
  'modelConfig.hidePresets': '收合預設設定',
  ...
  'modelConfig.setDefaultSuccess': '設置默認模型成功，請及時手動重啟pico-server模組',
  ...
  'knowledgeBaseManagement.ragConfig': '知識庫模型設定',
  'knowledgeBaseManagement.ragConfigHint': '知識庫使用的向量／檢索模型。此設定屬於知識庫功能，不在模型設定中單獨顯示。',
  'knowledgeBaseManagement.ragConfigLoadFailed': '取得知識庫模型失敗',
  'systemSettings.pageTitle': '系統設定',
  'systemSettings.reload': '重新載入',
  'systemSettings.save': '儲存',
  'systemSettings.saving': '儲存中',
  'systemSettings.hint': '這裡只保留 Pico 必需的伺服器參數。修改後會立即生效，請確認位址可被裝置存取。',
  'systemSettings.groupBasic': '基本資訊',
  'systemSettings.groupConnect': '服務位址',
  'systemSettings.groupSecurity': '安全',
  'systemSettings.groupIce': '備案資訊',
  'systemSettings.serverName': 'Pico 名稱',
  'systemSettings.serverNameHint': '裝置與網頁顯示的服務名稱。',
  'systemSettings.frontendUrl': '控制台位址',
  'systemSettings.frontendUrlHint': '裝置端顯示的控制台入口位址。',
  'systemSettings.authEnabled': '啟用服務驗證',
  'systemSettings.authEnabledHint': '關閉後裝置連線不再校驗 token，僅建議內網除錯使用。',
  'systemSettings.websocket': 'WebSocket 位址',
  'systemSettings.websocketHint': '多個位址以分號分隔；必須是裝置可存取的公開位址。',
  'systemSettings.ota': 'OTA 位址',
  'systemSettings.otaHint': '裝置檢查韌體更新的位址。',
  'systemSettings.serverSecret': '伺服器金鑰',
  'systemSettings.serverSecretHint': '裝置存取設定介面時使用的金鑰，修改後需同步更新裝置端。',
  'systemSettings.secretUnchanged': '留空表示不修改目前金鑰。',
  'systemSettings.beianIcp': 'ICP 備案號',
  'systemSettings.beianGa': '公安備案號',
  'systemSettings.loadFailed': '載入系統參數失敗',
  'systemSettings.noChange': '沒有需要儲存的修改',
  'systemSettings.saveSuccess': '系統設定已儲存',
  'systemSettings.savePartialFailed': '有 {count} 項儲存失敗，請檢查位址格式後重試',
