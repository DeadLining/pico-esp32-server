export default {
  ...
  'firmwareDialog.uploadHint': '温馨提示：请上传合并前的pico.bin文件，而不是合并后的merged-binary.bin文件',
  ...
  'paramManagement.updateSuccess': '修改成功，部分配置需重启pico-server模块才生效',
  ...
  'roleConfig.tooltip.contextProvider': '在Pico被唤醒时，获取外部系统的数据，并将其动态注入到大模型的系统提示词中',
  ...
  'modelConfig.effectiveConfig': '当前生效',
  'modelConfig.inUse': '使用中',
  'modelConfig.noEffective': '暂未选择生效配置',
  'modelConfig.showPresets': '展开其余 {count} 项预置',
  'modelConfig.hidePresets': '收起预置配置',
  ...
  'modelConfig.setDefaultSuccess': '设置默认模型成功，请及时手动重启pico-server模块',
  ...
  'knowledgeBaseManagement.ragConfig': '知识库模型配置',
  'knowledgeBaseManagement.ragConfigHint': '知识库使用的向量/检索模型。此配置属于知识库功能，不在模型配置中单独展示。',
  'knowledgeBaseManagement.ragConfigLoadFailed': '获取知识库模型失败',
  'systemSettings.pageTitle': '系统设置',
  'systemSettings.reload': '重新加载',
  'systemSettings.save': '保存',
  'systemSettings.saving': '保存中',
  'systemSettings.hint': '这里只保留 Pico 必需的服务器参数。修改后会立即生效，请确认地址可被设备访问。',
  'systemSettings.groupBasic': '基础信息',
  'systemSettings.groupConnect': '服务地址',
  'systemSettings.groupSecurity': '安全',
  'systemSettings.groupIce': '备案信息',
  'systemSettings.serverName': 'Pico 名称',
  'systemSettings.serverNameHint': '设备与网页显示的服务名称。',
  'systemSettings.frontendUrl': '控制台地址',
  'systemSettings.frontendUrlHint': '设备端展示的控制面板入口地址。',
  'systemSettings.authEnabled': '启用服务鉴权',
  'systemSettings.authEnabledHint': '关闭后设备连接不再校验 token，仅建议内网调试使用。',
  'systemSettings.websocket': 'WebSocket 地址',
  'systemSettings.websocketHint': '多个地址用分号分隔；必须是设备可访问的公网地址。',
  'systemSettings.ota': 'OTA 地址',
  'systemSettings.otaHint': '设备检查固件升级的地址。',
  'systemSettings.serverSecret': '服务器密钥',
  'systemSettings.serverSecretHint': '设备访问配置接口时使用的密钥，修改后需要同步更新设备端。',
  'systemSettings.secretUnchanged': '留空表示不修改当前密钥。',
  'systemSettings.beianIcp': 'ICP 备案号',
  'systemSettings.beianGa': '公安备案号',
  'systemSettings.loadFailed': '加载系统参数失败',
  'systemSettings.noChange': '没有需要保存的修改',
  'systemSettings.saveSuccess': '系统设置已保存',
  'systemSettings.savePartialFailed': '有 {count} 项保存失败，请检查地址格式后重试',
