export default {
  ...
  'header.deviceManagement': 'Device Management',
  ...
  'firmwareDialog.uploadHint': 'Warm reminder: Please upload the pre-merged pico.bin file, not the merged merged-binary.bin file',
  ...
  'register.welcome': 'Welcome to Pico AI',
  ...
  'paramManagement.updateSuccess': 'Update successful. Some configurations will take effect only after restarting the pico-server module.',
  ...
  'roleConfig.tooltip.contextProvider': 'When Pico is awakened, fetch external system data and dynamically inject it into the LLM system prompt',
  ...
  'modelConfig.effectiveConfig': 'Currently in effect',
  'modelConfig.inUse': 'In use',
  'modelConfig.noEffective': 'No effective configuration yet',
  'modelConfig.showPresets': 'Show {count} more presets',
  'modelConfig.hidePresets': 'Hide presets',
  ...
  'modelConfig.setDefaultSuccess': 'Set default model successful, please restart the pico-server module manually in time',
  ...
  'knowledgeBaseManagement.ragConfig': 'Knowledge Base Model',
  'knowledgeBaseManagement.ragConfigHint': 'Vector and retrieval model used by knowledge bases. This belongs to the knowledge base feature and is no longer shown under model configuration.',
  'knowledgeBaseManagement.ragConfigLoadFailed': 'Failed to load knowledge base models',
  'systemSettings.pageTitle': 'System Settings',
  'systemSettings.reload': 'Reload',
  'systemSettings.save': 'Save',
  'systemSettings.saving': 'Saving',
  'systemSettings.hint': 'Only Pico-required server parameters are kept here. Changes take effect immediately; make sure the addresses are reachable by devices.',
  'systemSettings.groupBasic': 'Basic',
  'systemSettings.groupConnect': 'Service Addresses',
  'systemSettings.groupSecurity': 'Security',
  'systemSettings.groupIce': 'Filing Information',
  'systemSettings.serverName': 'Pico Name',
  'systemSettings.serverNameHint': 'Service name shown on devices and the console.',
  'systemSettings.frontendUrl': 'Console URL',
  'systemSettings.frontendUrlHint': 'Console entry URL shown to devices.',
  'systemSettings.authEnabled': 'Service authentication',
  'systemSettings.authEnabledHint': 'When disabled, devices connect without token validation. Use only for intranet debugging.',
  'systemSettings.websocket': 'WebSocket URLs',
  'systemSettings.websocketHint': 'Separate multiple URLs with semicolons; they must be reachable by devices.',
  'systemSettings.ota': 'OTA URL',
  'systemSettings.otaHint': 'Address where devices check for firmware updates.',
  'systemSettings.serverSecret': 'Server secret',
  'systemSettings.serverSecretHint': 'Used by devices to access the config API. Update the device side after changing it.',
  'systemSettings.secretUnchanged': 'Leave empty to keep the current secret.',
  'systemSettings.beianIcp': 'ICP filing number',
  'systemSettings.beianGa': 'Public security filing number',
  'systemSettings.loadFailed': 'Failed to load system parameters',
  'systemSettings.noChange': 'Nothing to save',
  'systemSettings.saveSuccess': 'System settings saved',
  'systemSettings.savePartialFailed': '{count} item(s) failed to save; check the address format and retry',
