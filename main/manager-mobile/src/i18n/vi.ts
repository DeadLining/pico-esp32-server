...
export default {
  ...
  'settings.validServerUrl': 'Vui lòng nhập địa chỉ máy chủ hợp lệ (bắt đầu bằng http hoặc https và kết thúc bằng /pico)',
  ...
  // Về chúng tôi
  'settings.aboutApp': 'Về Bảng điều khiển Pico',
  'settings.aboutContent': 'Bảng điều khiển Pico\n\nỨng dụng quản lý di động đa nền tảng được xây dựng với Vue.js 3 + uni-app, cung cấp quản lý thiết bị, cấu hình đại lý và các chức năng khác cho phần cứng thông minh pico ESP32.\n\n© 2025 pico-esp32-server {version}',
  ...
  'deviceConfig.connectToPicoHotspot': 'Vui lòng kết nối với điểm phát sóng pico trước',
  'deviceConfig.detecting': 'Đang phát hiện...',
  'deviceConfig.reDetect': 'Phát hiện lại',
  'deviceConfig.alreadyConnected': 'Đã kết nối với điểm phát sóng pico',
  ...
  'deviceConfig.bringPhoneCloseToPicoDevice': 'Đưa điện thoại lại gần thiết bị pico (khoảng cách 1-2 mét)',
  'deviceConfig.duringAudioPlaybackPicoWillReceive': 'Trong khi phát âm thanh, pico sẽ nhận và giải mã thông tin cấu hình',
  ...
  'deviceConfig.connectPicoHotspot': 'Vui lòng kết nối với điểm phát sóng pico',
  ...
  'deviceConfig.connectedPicoHotspot': 'Đã kết nối với điểm phát sóng pico',
  ...
  'deviceConfig.pleaseDisconnectPicoHotspot': 'Vui lòng ngắt kết nối khỏi điểm phát sóng pico',
  ...
  'deviceConfig.phoneConnectPicoHotspot': 'Điện thoại kết nối với điểm phát sóng pico',
