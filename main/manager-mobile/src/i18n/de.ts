...
export default {
  ...
  'settings.validServerUrl': 'Bitte gültige Serveradresse eingeben (beginnt mit http oder https und endet mit /pico)',
  ...
  // Über uns
  'settings.aboutApp': 'Über Pico Konsole',
  'settings.aboutContent': 'Pico Konsole\n\nEine plattformübergreifende mobile Management-App, erstellt mit Vue.js 3 + uni-app, bietet Geräteverwaltung, Agentenkonfiguration und andere Funktionen für pico ESP32 Smart Hardware.\n\n© 2025 pico-esp32-server {version}',
  ...
  'deviceConfig.connectToPicoHotspot': 'Bitte verbinden Sie sich zuerst mit dem pico Hotspot',
  'deviceConfig.detecting': 'Erkennen...',
  'deviceConfig.reDetect': 'Erneut erkennen',
  'deviceConfig.alreadyConnected': 'Mit pico Hotspot verbunden',
  ...
  'deviceConfig.bringPhoneCloseToPicoDevice': 'Bringen Sie das Telefon in die Nähe des pico Geräts (1-2 Meter Entfernung)',
  'deviceConfig.duringAudioPlaybackPicoWillReceive': 'Während der Audio-Wiedergabe empfängt pico und dekodiert Konfigurationsinformationen',
  ...
  'deviceConfig.connectPicoHotspot': 'Bitte verbinden Sie sich mit dem pico Hotspot',
  ...
  'deviceConfig.connectedPicoHotspot': 'Mit pico Hotspot verbunden',
  ...
  'deviceConfig.pleaseDisconnectPicoHotspot': 'Bitte trennen Sie sich vom pico Hotspot',
  ...
  'deviceConfig.phoneConnectPicoHotspot': 'Telefon mit pico Hotspot verbinden',
