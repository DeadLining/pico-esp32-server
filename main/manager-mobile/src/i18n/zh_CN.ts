...
export default {
  ...
  'settings.validServerUrl': '请输入有效的服务端地址（以 http 或 https 开头，并以 /pico 结尾）',
  ...
  // 关于我们
  'settings.aboutApp': '关于Pico智控台',
  'settings.aboutContent': 'Pico智控台\n\n基于 Vue.js 3 + uni-app 构建的跨平台移动端管理应用，为PicoESP32智能硬件提供设备管理、智能体配置等功能。\n\n© 2025 pico-esp32-server {version}',
  ...
  'deviceConfig.connectToPicoHotspot': '请先连接pico热点 (pico-XXXXXX)',
  'deviceConfig.detecting': '检测中...',
  'deviceConfig.reDetect': '重新检测',
  'deviceConfig.alreadyConnected': '已连接pico热点',
  ...
  'deviceConfig.bringPhoneCloseToPicoDevice': '将手机靠近pico设备（距离1-2米）',
  'deviceConfig.duringAudioPlaybackPicoWillReceive': '音频播放时，pico会接收并解码配网信息',
  ...
  'deviceConfig.connectPicoHotspot': '请连接pico热点',
  ...
  'deviceConfig.connectedPicoHotspot': '已连接pico热点',
  ...
  'deviceConfig.pleaseDisconnectPicoHotspot': '请断开pico热点连接',
  ...
  'deviceConfig.phoneConnectPicoHotspot': '手机连接pico热点',
