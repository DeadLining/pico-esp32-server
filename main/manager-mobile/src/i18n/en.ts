...
export default {
  ...
  'settings.validServerUrl': 'Please enter a valid server address (starting with http or https and ending with /pico)',
  ...
  // About us
  'settings.aboutApp': 'About Pico Console',
  'settings.aboutContent': 'Pico Console\n\nA cross-platform mobile management app built with Vue.js 3 + uni-app, providing device management, agent configuration and other functions for pico ESP32 smart hardware.\n\n© 2025 pico-esp32-server {version}',
  ...
  'deviceConfig.connectToPicoHotspot': 'Please connect to pico hotspot first',
  'deviceConfig.detecting': 'Detecting...',
  'deviceConfig.reDetect': 'Re-detect',
  'deviceConfig.alreadyConnected': 'Connected to pico hotspot',
  ...
  'deviceConfig.bringPhoneCloseToPicoDevice': 'Bring phone close to pico device (1-2 meters distance)',
  'deviceConfig.duringAudioPlaybackPicoWillReceive': 'During audio playback, pico will receive and decode configuration information',
  ...
  'deviceConfig.connectPicoHotspot': 'Please connect to pico hotspot',
  ...
  'deviceConfig.connectedPicoHotspot': 'Connected to pico hotspot',
  ...
  'deviceConfig.pleaseDisconnectPicoHotspot': 'Please disconnect from pico hotspot',
  ...
  'deviceConfig.phoneConnectPicoHotspot': 'Phone connect to pico hotspot',
