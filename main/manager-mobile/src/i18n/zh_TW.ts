...
export default {
  ...
  'settings.validServerUrl': '請輸入有效的服務端地址（以 http 或 https 開頭，並以 /pico 結尾）',
  ...
  // 關於我們
  'settings.aboutApp': '關於Pico智控台',
  'settings.aboutContent': 'Pico智控台\n\n基於 Vue.js 3 + uni-app 構建的跨平台移動端管理應用，為PicoESP32智能硬體提供設備管理、智能體配置等功能。\n\n© 2025 pico-esp32-server {version}',
  ...
  'deviceConfig.connectToPicoHotspot': '請先連接pico熱點 (pico-XXXXXX)',
  'deviceConfig.detecting': '檢測中...',
  'deviceConfig.reDetect': '重新檢測',
  'deviceConfig.alreadyConnected': '已連接pico熱點',
  ...
  'deviceConfig.bringPhoneCloseToPicoDevice': '將手機靠近pico設備（距離1-2米）',
  'deviceConfig.duringAudioPlaybackPicoWillReceive': '音頻播放時，pico會接收並解碼配網信息',
  ...
  'deviceConfig.connectPicoHotspot': '請連接pico熱點',
  ...
  'deviceConfig.connectedPicoHotspot': '已連接pico熱點',
  ...
  'deviceConfig.pleaseDisconnectPicoHotspot': '請斷開pico熱點連接',
  ...
  'deviceConfig.phoneConnectPicoHotspot': '手機連接pico熱點',
