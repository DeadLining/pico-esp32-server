...
```
2025-06-01 **** - OTA接口是           http://192.168.4.7:8003/pico/ota/
2025-06-01 **** - 视觉分析接口是        http://192.168.4.7:8003/mcp/vision/explain
2025-06-01 **** - Websocket地址是       ws://192.168.4.7:8000/pico/v1/
