...
1. 在[pico-esp32](https://github.com/78/xiaozhi-esp32) 代码的基础上增加远程唤醒工具MCP，版本支持为2.1.0至2.2.6（2026年5月29日的版本）
...
准备两个设备，在智控台上面配置好通讯权限和在智能体中添加呼叫工具之后，在其中一个Pico对话那里对他说：”呼叫XXX“，观察设备B是否响应。
