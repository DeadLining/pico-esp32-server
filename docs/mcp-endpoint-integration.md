...
本教程的前提是，你的`pico-server`已经启用了mcp接入点功能，如果你还没启用，可以先根据[这个教程](./mcp-endpoint-enable.md)启用。
...
250705[__main__]-INFO-OTA接口是          http://192.168.1.25:8002/pico/ota/
...
250705[__main__]-INFO-Websocket地址是    ws://192.168.1.25:8000/pico/v1/
